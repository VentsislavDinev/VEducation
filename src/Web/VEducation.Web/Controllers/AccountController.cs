...
using VEducation.Data.ViewModels.Account;
...
using VEducation.Web.Controllers.Results;
using VEducation.Web.Models;
        ...
        public virtual async Task<ActionResult> Register(RegisterViewModel model)
        {
            try
            {
                ...
                if (model.IsExternalLogin)
                {
                    ...
                    model.Password = VEducation.Infrastructure.Core.Users.User.CreateRandomPassword();
