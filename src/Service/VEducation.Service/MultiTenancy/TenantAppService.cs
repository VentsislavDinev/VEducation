...
using VEducation.Service.MultiTenancy.Dto;

namespace VEducation.Service.MultiTenancy
{
    /// <summary>
    /// The tenant app service.
    /// </summary>
    public class TenantAppService : EducationAppServiceBase, ITenantAppService
    {
        /// <summary>
        /// The _tenant manager.
        /// </summary>
